...
REQUIREMENT_MODULE:            'RM'; // Also assign.
MINI_QUERY:            'MQ'; // Also assign.
TARGET_QUERY:            'TARGET_QUERY'; // Also assign.
UNION_QUERY:            'UNIONQuery'; // Also assign.
CARDINALITYN:            N; // Also assign.
ONE:            '1'; // Also assign.
//-------------------------------------------------------------------------------------------------
...
CONTRIBUTORS_SYMBOL:             C O N T R I B U T O R S                     ;
...
CURTIME_SYMBOL:                  C U R T I M E                               ; // MYSQL-FUNC
...
MASTER_AUTO_POSITION_SYMBOL:     M A S T E R '_' A U T O '_' P O S I T I O N ;
...
MASTER_TLS_VERSION_SYMBOL:       M A S T E R '_' T L S '_' V E R S I O N     ;
...
MAX_STATEMENT_TIME_SYMBOL:
    M A X '_' S T A T E M E N T '_' T I M E                                  
;
...
NONBLOCKING_SYMBOL:              N O N B L O C K I N G                       ;
NOT_SYMBOL:
    N O T                                                                    
;                                                                            // SQL-2003-R
NOW_SYMBOL:                      N O W                                       ;
...
;                                                                            // SQL-2003-N
STDDEV_SYMBOL:                   S T D D E V                                 ; // Synonym
STDDEV_POP_SYMBOL:               S T D D E V '_' P O P                       ; // Synonym
STD_SYMBOL:                      S T D                                       ;
STOP_SYMBOL:                     S T O P;
...
SUBSTR_SYMBOL:                   S U B S T R                                 ; // Synonym
...
SYSTEM_USER_SYMBOL:              S Y S T E M '_' U S E R                     ;
...
VAR_POP_SYMBOL:                  V A R '_' P O P                             ; // Synonym
...
REMOTE_SYMBOL:                   R E M O T E                                 ; // MYSQL
...
GET_MASTER_PUBLIC_KEY_SYMBOL:
    G E T '_' M A S T E R '_' P U B L I C '_' K E Y '_' S Y M                
;                                                                            // MYSQL
RESTART_SYMBOL:                  R E S T A R T                               ; // SQL-2003-N
DEFINITION_SYMBOL:               D E F I N I T I O N                         ; // MYSQL
DESCRIPTION_SYMBOL:              D E S C R I P T I O N                       ; // MYSQL
ORGANIZATION_SYMBOL:             O R G A N I Z A T I O N                     ; // MYSQL
REFERENCE_SYMBOL:                R E F E R E N C E                           ; // MYSQL

OPTIONAL_SYMBOL:                 O P T I O N A L                             ; // MYSQL
SECONDARY_SYMBOL:                S E C O N D A R Y                           ; // MYSQL
SECONDARY_ENGINE_SYMBOL:         S E C O N D A R Y '_' E N G I N E           ; // MYSQL
SECONDARY_LOAD_SYMBOL:           S E C O N D A R Y '_' L O A D               ; // MYSQL
SECONDARY_UNLOAD_SYMBOL:         S E C O N D A R Y '_' U N L O A D           ; // MYSQL

ACTIVE_SYMBOL:                   A C T I V E                                 ; // MYSQL
INACTIVE_SYMBOL:                 I N A C T I V E                             ; // MYSQL
LATERAL_SYMBOL:                  L A T E R A L                               ; // SQL-2003-R
RETAIN_SYMBOL:                   R E T A I N                                 ; // MYSQL
OLD_SYMBOL:                      O L D                                       ; // SQL-2003-R

NETWORK_NAMESPACE_SYMBOL:        N E T W O R K '_' N A M E S P A C E         ; // MYSQL
ENFORCED_SYMBOL:                 E N F O R C E D                             ; // SQL-2003-N
ARRAY_SYMBOL:                    A R R A Y                                   ; // SQL-2003-R
OJ_SYMBOL:                       O J                                         ; // ODBC
MEMBER_SYMBOL:                   M E M B E R                                 ; // SQL-2003-R

RANDOM_SYMBOL:                   R A N D O M                                 ; // MYSQL
MASTER_COMPRESSION_ALGORITHM_SYMBOL:
    M A S T E R '_' C O M P R E S S I O N '_' A L G O R I T H M              
;                                                                            // MYSQL
MASTER_ZSTD_COMPRESSION_LEVEL_SYMBOL:
    M A S T E R '_' Z S T D '_' C O M P R E S S I O N '_' L E V E L          
;                                                                            // MYSQL
PRIVILEGE_CHECKS_USER_SYMBOL:
    P R I V I L E G E '_' C H E C K S '_' U S E R                            
;                                                                            // MYSQL
MASTER_TLS_CIPHERSUITES_SYMBOL:
    M A S T E R '_' T L S '_' C I P H E R S U I T E S                        
;                                                                            // MYSQL

REQUIRE_ROW_FORMAT_SYMBOL:
    R E Q U I R E '_' R O W '_' F O R M A T                                  
;                                                                            // MYSQL
...
REQUIRE_TABLE_PRIMARY_KEY_CHECK_SYMBOL:
    R E Q U I R E '_' T A B L E '_' P R I M A R Y '_' K E Y '_' C H E C K    
;                                                                            // MYSQL
